...
ARCHIVEDIR="/srv/collector/data/indexed/archive"
WORKDIR="/srv/collector/data/tarballs"
OUTDIR="/srv/collector/data/out"
TARBALLTARGETDIR="/srv/collector/data/tarballsdata"
